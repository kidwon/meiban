...
export default {
  ...
  astrology: {
    ...
    titleTemplates: {
      ...
      jupiter: '木星{sign}｜扩展与成长',
      saturn: '土星{sign}｜约束与责任',
      uranus: '天王星{sign}｜变革与创新',
    ...
    detailed: {
      ...
      mercury: {
        ...
        aries: {
          thinking: '思维快速敏捷，善于做出迅速决断，具有开创性思考能力。',
          communication: '直接坦率，说话快速有力，善于激励他人采取行动。',
          learning: '喜欢快节奏的学习方式，通过实践和竞争能更好地掌握知识。'
        },
        taurus: {
          thinking: '思考稳重务实，注重实际价值，偏爱循序渐进的思维方式。',
          communication: '表达谨慎可靠，言语温和，善于用具体例子说明问题。',
          learning: '喜欢稳定的学习环境，通过重复练习和感官体验来巩固知识。'
        },
        gemini: {
          thinking: '思维灵活多变，善于处理多项任务，具有强烈的好奇心和学习欲。',
          communication: '表达流畅机智，善于社交，能够适应不同的沟通对象和场合。',
          learning: '学习能力极强，喜欢多样化的学习内容，通过交流和阅读快速获取信息。'
        },
        cancer: {
          thinking: '思考带有情感色彩，注重直觉感受，善于记忆和回忆过往经历。',
          communication: '表达温和体贴，善于倾听，能够理解他人的情感需求。',
          learning: '通过情感联系和个人体验来学习，在舒适安全的环境中学习效果最佳。'
        },
        leo: {
          thinking: '思考带有创造性和戏剧性，善于表达个人观点，注重思想的独创性。',
          communication: '表达自信有魅力，善于演讲和表演，能够吸引他人的注意力。',
          learning: '喜欢受到关注和认可的学习方式，通过展示和分享来巩固知识。'
        },
        virgo: {
          thinking: '思考细致精确，善于分析和归纳，注重逻辑性和条理性。',
          communication: '表达准确严谨，善于提供实用建议，能够发现细节中的问题。',
          learning: '喜欢系统性的学习方法，通过练习和改进来完善技能。'
        },
        libra: {
          thinking: '思考追求平衡和和谐，善于从多个角度考虑问题，注重公平公正。',
          communication: '表达优雅得体，善于协调和调解，能够维持良好的人际关系。',
          learning: '喜欢在协作和讨论中学习，通过比较和对比来理解概念。'
        },
        scorpio: {
          thinking: '思考深入透彻，善于洞察本质，具有强烈的专注力和研究精神。',
          communication: '表达深刻有力，善于揭示真相，能够触及他人内心深处。',
          learning: '喜欢深度学习和研究，通过探索和发现来获得知识的满足感。'
        },
        sagittarius: {
          thinking: '思考开阔乐观，善于哲学思辨，具有强烈的求知欲和探索精神。',
          communication: '表达热情坦率，善于讲述和教导，能够激发他人的学习兴趣。',
          learning: '喜欢广泛的学习内容，通过旅行和体验来拓展知识视野。'
        },
        capricorn: {
          thinking: '思考实用理性，善于制定计划，注重效率和实际成果。',
          communication: '表达严肃专业，善于工作汇报，能够清楚传达目标和要求。',
          learning: '喜欢目标导向的学习方式，通过实际应用来检验知识的价值。'
        },
        aquarius: {
          thinking: '思考独特前卫，善于创新思辨，具有强烈的独立思考能力。',
          communication: '表达理性客观，善于讨论理念，能够传播新颖的观点和想法。',
          learning: '喜欢自主学习和实验，通过观察和假设来探索知识的可能性。'
        },
        pisces: {
          thinking: '思考富有想象力，善于直觉感知，注重精神层面的理解和感悟。',
          communication: '表达感性诗意，善于艺术表达，能够用情感和意境传达信息。',
          learning: '喜欢启发式的学习方式，通过艺术和冥想来获得深层的智慧。'
        }
      },
      jupiter: {
        aries: {
          strengths: '具有强烈的开拓精神和领导能力，在新的领域能够快速扩展。',
          opportunities: '在创业、竞技、军事等需要开拓精神的领域有很好的发展机会。',
          guidance: '发挥你的勇气和领导力，但要学会耐心和策略性思考。'
        },
        taurus: {
          strengths: '在物质和财富积累方面有天赋，能够稳步建立财富基础。',
          opportunities: '在金融、艺术、美容、农业等领域有良好的发展前景。',
          guidance: '发挥你的实用智慧，但要保持对新机会的开放心态。'
        },
        gemini: {
          strengths: '学习能力强，善于沟通，能在多个领域同时发展。',
          opportunities: '在教育、媒体、科技、写作等需要沟通的领域有优势。',
          guidance: '利用你的多才多艺，但要在某个领域深入专业化。'
        },
        cancer: {
          strengths: '在与家庭、情感相关的领域有天赋，能够照顾和保护他人。',
          opportunities: '在教育、医疗、餐饮、房地产等关怀行业有发展潜力。',
          guidance: '发挥你的同情心和直觉，用于帮助和启发他人。'
        },
        leo: {
          strengths: '具有天生的表现力和创造力，能够激励和影响他人。',
          opportunities: '在娱乐、艺术、教育、管理等需要表现力的领域有优势。',
          guidance: '发挥你的创造力和领导魅力，但要保持谦逊和团队精神。'
        },
        virgo: {
          strengths: '注重细节和服务，在分析和改进方面有天赋。',
          opportunities: '在医疗、会计、编辑、研究等需要精确性的领域有优势。',
          guidance: '发挥你的分析能力和完美主义，但要避免过度挑剔。'
        },
        libra: {
          strengths: '在美学和人际关系方面有天赋，能够创造和谐平衡。',
          opportunities: '在法律、艺术、外交、咨询等需要平衡能力的领域有优势。',
          guidance: '发挥你的协调能力和美感，但要学会在必要时做出坚定决定。'
        },
        scorpio: {
          strengths: '具有深刻的洞察力和转化能力，能够在危机中找到机会。',
          opportunities: '在心理学、研究、投资、医疗等深度领域有优势。',
          guidance: '发挥你的洞察力和转化能力，但要学会宽恕和释怀。'
        },
        sagittarius: {
          strengths: '具有探索精神和哲学思维，能够拓展视野和境界。',
          opportunities: '在教育、旅游、出版、宗教等扩展性领域有优势。',
          guidance: '发挥你的理想主义和探索精神，但要注重实际可行性。'
        },
        capricorn: {
          strengths: '具有强烈的责任感和组织能力，能够建立稳固的成就。',
          opportunities: '在管理、政治、建筑、传统行业等需要稳定性的领域有优势。',
          guidance: '发挥你的组织能力和责任感，但要保持对创新的开放态度。'
        },
        aquarius: {
          strengths: '具有前瞻性思维和社会意识，能够为集体利益而努力。',
          opportunities: '在科技、社会改革、团体组织等创新领域有优势。',
          guidance: '发挥你的创新精神和社会意识，但要平衡理想与现实。'
        },
        pisces: {
          strengths: '具有丰富的想象力和同情心，能够启发和治愈他人。',
          opportunities: '在艺术、心灵疗愈、慈善、精神领域有优势。',
          guidance: '发挥你的直觉和同情心，但要设定明确的界限和目标。'
        }
      },
      saturn: {
        aries: {
          challenges: '需要学习耐心和策略，避免冲动行事造成的后果。',
          lessons: '培养持久的毅力和长远规划能力，学会在行动前深思熟虑。',
          growth: '通过面对挑战建立真正的自信，成为有责任感的领导者。'
        },
        taurus: {
          challenges: '需要克服过度固执和对变化的抗拒，学会灵活适应。',
          lessons: '建立真正的安全感，学会在稳定与变化之间找到平衡。',
          growth: '通过持续努力建立坚实基础，成为可靠的支柱。'
        },
        gemini: {
          challenges: '需要深化思考和专注力，避免表面化和散漫。',
          lessons: '培养深度学习能力，学会在多样性中保持连贯性。',
          growth: '通过系统学习建立真正的智慧，成为有深度的沟通者。'
        },
        cancer: {
          challenges: '需要建立情绪边界，避免过度依恋和保护欲。',
          lessons: '学会独立自主，在关怀他人的同时也要照顾自己。',
          growth: '通过情感成熟建立真正的安全感，成为智慧的守护者。'
        },
        leo: {
          challenges: '需要克服自我中心，学会真正的领导力和谦逊。',
          lessons: '建立基于服务的权威，学会在表现自我时也要考虑他人。',
          growth: '通过承担责任建立真正的威信，成为令人尊敬的领袖。'
        },
        virgo: {
          challenges: '需要克服完美主义和过度批判，学会接受不完美。',
          lessons: '培养建设性的改进精神，学会在细节和整体间找平衡。',
          growth: '通过服务他人建立真正的价值感，成为有智慧的改进者。'
        },
        libra: {
          challenges: '需要学会独立决策，避免过度依赖他人意见。',
          lessons: '建立内在的平衡感，学会在和谐与原则间找到平衡。',
          growth: '通过承担责任建立真正的合作能力，成为公正的调解者。'
        },
        scorpio: {
          challenges: '需要学会放下控制欲和报复心理，拥抱转化。',
          lessons: '培养真正的内在力量，学会在深度与健康间找平衡。',
          growth: '通过面对内心阴影建立真正的力量，成为智慧的转化者。'
        },
        sagittarius: {
          challenges: '需要将理想与现实结合，避免盲目乐观。',
          lessons: '建立基于智慧的信念系统，学会承担传播真理的责任。',
          growth: '通过践行理想建立真正的智慧，成为有责任感的导师。'
        },
        capricorn: {
          challenges: '需要平衡事业与个人生活，避免过度压抑情感。',
          lessons: '建立可持续的成功模式，学会在成就与幸福间找平衡。',
          growth: '通过承担重责建立真正的权威，成为值得信赖的建设者。'
        },
        aquarius: {
          challenges: '需要学会与传统合作，避免为了不同而不同。',
          lessons: '建立有建设性的改革精神，学会在创新与稳定间找平衡。',
          growth: '通过承担社会责任建立真正的影响力，成为智慧的改革者。'
        },
        pisces: {
          challenges: '需要建立现实感和界限，避免过度同情和逃避。',
          lessons: '培养实用的同情心，学会在理想与现实间找到平衡。',
          growth: '通过承担精神责任建立真正的智慧，成为有界限的治愈者。'
        }
      },
      uranus: {
        aries: {
          innovations: '在个人表达和独立精神方面有突破性创新能力。',
          independence: '强烈追求个人自由和独特性，不愿被传统束缚。',
          guidance: '发挥开拓精神推动个人和社会进步，但要考虑他人感受。'
        },
        taurus: {
          innovations: '在物质世界和价值观念方面带来渐进性变革。',
          independence: '以稳定的方式追求改变，在保守中寻求创新。',
          guidance: '用实用方式推动变革，但要保持对新思想的开放性。'
        },
        gemini: {
          innovations: '在沟通和信息传播方面有革命性的创新思维。',
          independence: '追求思想自由和表达多样性，拒绝单一观点。',
          guidance: '发挥多元思维推动沟通革新，但要保持思想的深度。'
        },
        cancer: {
          innovations: '在家庭结构和情感表达方面带来突破性改变。',
          independence: '以关怀方式追求个人自由，在传统与创新间寻求平衡。',
          guidance: '用温和方式推动情感革新，但要保持稳定的根基。'
        },
        leo: {
          innovations: '在创意表达和个人表现方面有独特的创新能力。',
          independence: '追求创意自由和个人独特性，不愿模仿他人。',
          guidance: '发挥创造力推动艺术革新，但要避免过度自我中心。'
        },
        virgo: {
          innovations: '在服务和改进方面带来系统性的创新方法。',
          independence: '以实用方式追求完善，在传统方法中寻求改进。',
          guidance: '用分析能力推动实用创新，但要避免过度苛求完美。'
        },
        libra: {
          innovations: '在人际关系和美学领域带来平衡性的创新理念。',
          independence: '追求关系中的平等和美的新标准。',
          guidance: '发挥协调能力推动关系革新，但要坚持自己的原则。'
        },
        scorpio: {
          innovations: '在深层变革和心理领域有穿透性的创新洞察。',
          independence: '追求根本性的转化和内在自由。',
          guidance: '发挥洞察力推动深层变革，但要避免破坏性冲动。'
        },
        sagittarius: {
          innovations: '在哲学思想和国际视野方面有开拓性的创新精神。',
          independence: '追求思想自由和精神解放，拒绝狭隘观念。',
          guidance: '发挥探索精神推动思想革新，但要保持实用性。'
        },
        capricorn: {
          innovations: '在社会结构和权威体系方面带来建设性的创新改革。',
          independence: '以负责任的方式追求体系改革和制度创新。',
          guidance: '用组织能力推动结构革新，但要保持人性化考量。'
        },
        aquarius: {
          innovations: '在集体意识和未来愿景方面有前瞻性的创新思维。',
          independence: '追求人类整体的自由和进步，拒绝狭隘个人主义。',
          guidance: '发挥人道精神推动社会革新，但要脚踏实地执行。'
        },
        pisces: {
          innovations: '在精神领域和集体无意识方面有直觉性的创新洞察。',
          independence: '追求精神自由和超越传统的灵性体验。',
          guidance: '发挥直觉能力推动精神革新，但要保持与现实的联系。'
        }
      },
      neptune: {
        aries: {
          intuition: '在行动和自我表达方面有敏锐的直觉指导。',
          dreams: '梦想成为独特的个体，用理想主义指导个人行动。',
          guidance: '相信内在冲动的智慧，但要在理想与现实间找到平衡。'
        },
        taurus: {
          intuition: '在物质和美感方面有深刻的精神洞察。',
          dreams: '梦想创造持久的美和价值，将精神融入物质世界。',
          guidance: '用精神价值观指导物质选择，但要保持实用性。'
        },
        gemini: {
          intuition: '在沟通和学习方面有多元化的精神感知。',
          dreams: '梦想通过沟通传播智慧，连接不同的思想和文化。',
          guidance: '相信多元沟通的力量，但要避免信息过载和混乱。'
        },
        cancer: {
          intuition: '在情感和家庭方面有深刻的共情能力。',
          dreams: '梦想创造充满爱的安全港湾，治愈他人的情感创伤。',
          guidance: '用同情心指导行动，但要建立健康的情感界限。'
        },
        leo: {
          intuition: '在创造和表达方面有灵感的直觉指导。',
          dreams: '梦想通过创意表达启发他人，成为精神光芒的源泉。',
          guidance: '相信创造力的神圣性，但要避免自我膨胀和虚荣。'
        },
        virgo: {
          intuition: '在服务和完善方面有精神层面的敏感性。',
          dreams: '梦想通过完美的服务帮助他人，将精神理念落实到实际行动。',
          guidance: '用服务精神指导行动，但要避免过度牺牲自我。'
        },
        libra: {
          intuition: '在美感和和谐方面有艺术性的精神感知。',
          dreams: '梦想创造完美的和谐与美，平衡所有对立的力量。',
          guidance: '相信美与和谐的治愈力量，但要在理想与现实间找平衡。'
        },
        scorpio: {
          intuition: '在深层心理和转化方面有穿透性的精神洞察。',
          dreams: '梦想深度转化自己和他人，揭示隐藏的真相和力量。',
          guidance: '相信转化的神圣性，但要避免执迷于黑暗面。'
        },
        sagittarius: {
          intuition: '在哲学和精神探索方面有广阔的直觉视野。',
          dreams: '梦想传播普世智慧，连接不同的精神传统和文化。',
          guidance: '相信精神探索的意义，但要保持开放和包容的心态。'
        },
        capricorn: {
          intuition: '在责任和成就方面有务实的精神感知。',
          dreams: '梦想建立有精神意义的成就，将理想落实为实际贡献。',
          guidance: '用精神价值观指导事业选择，但要避免过度严苛。'
        },
        aquarius: {
          intuition: '在集体和未来方面有人道主义的精神洞察。',
          dreams: '梦想为人类整体福祉贡献力量，创造更美好的未来。',
          guidance: '相信集体智慧和人道精神，但要脚踏实地行动。'
        },
        pisces: {
          intuition: '在精神和无意识方面有最深刻的直觉能力。',
          dreams: '梦想与宇宙意识融合，成为爱与慈悲的化身。',
          guidance: '相信无限的爱与智慧，但要在现实中保持清醒。'
        }
      },
      pluto: {
        aries: {
          transformation: '在个人意志和自我表达方面有深刻的转化力量。',
          power: '拥有重塑个人身份和开创新局面的强大内在力量。',
          guidance: '勇敢面对自我改变的挑战，用个人转化激励他人成长。'
        },
        taurus: {
          transformation: '在价值观和物质安全方面经历根本性转化。',
          power: '拥有重建价值体系和创造持久变化的深层力量。',
          guidance: '接受价值观的深度转变，用稳定力量支持他人转化。'
        },
        gemini: {
          transformation: '在思维方式和沟通表达方面有革命性变化。',
          power: '拥有重塑信息传播和思想交流的深刻影响力。',
          guidance: '拥抱思维的深度转化，用智慧言语引导他人觉醒。'
        },
        cancer: {
          transformation: '在情感根基和家庭结构方面经历深层重建。',
          power: '拥有治愈情感创伤和重塑安全感的强大能力。',
          guidance: '勇敢面对情感深层转化，用关爱力量帮助他人疗愈。'
        },
        leo: {
          transformation: '在创造表达和个人权威方面有根本性重塑。',
          power: '拥有重新定义领导力和创造力的深刻影响力。',
          guidance: '接受创造力的深度转化，用真诚魅力启发他人潜能。'
        },
        virgo: {
          transformation: '在服务理念和完善方式方面经历深刻改变。',
          power: '拥有重新定义服务和效率的精确转化能力。',
          guidance: '拥抱服务精神的深度转化，用实用智慧帮助他人成长。'
        },
        libra: {
          transformation: '在关系模式和美学标准方面有根本性重塑。',
          power: '拥有重新定义和谐与美的深刻影响力。',
          guidance: '接受关系的深度转化，用平衡智慧引导和谐共存。'
        },
        scorpio: {
          transformation: '在最深层的心理和灵魂层面经历彻底重生。',
          power: '拥有最强大的洞察力和转化他人的神秘力量。',
          guidance: '勇敢面对最深层的转化，用重生智慧引导他人觉醒。'
        },
        sagittarius: {
          transformation: '在信念体系和人生哲学方面有革命性重建。',
          power: '拥有重新定义智慧和真理的深远影响力。',
          guidance: '接受信念的深度转化，用智慧之光照亮他人前路。'
        },
        capricorn: {
          transformation: '在权威结构和成就方式方面经历根本性重组。',
          power: '拥有重新定义权威和责任的强大建设力量。',
          guidance: '拥抱权威的深度转化，用负责任的力量重建秩序。'
        },
        aquarius: {
          transformation: '在集体意识和社会结构方面有革命性变革。',
          power: '拥有重塑人类未来和集体进化的深远力量。',
          guidance: '接受社会意识的深度转化，用人道精神引领集体觉醒。'
        },
        pisces: {
          transformation: '在精神层面和集体无意识方面经历最深刻的融合。',
          power: '拥有连接宇宙意识和引导精神觉醒的最高力量。',
          guidance: '拥抱精神的终极转化，用无条件的爱引导众生解脱。'
        }
      },
      northNode: {
        aries: {
          purpose: '此生需要发展勇气、独立性和领导能力，学会为自己而活。',
          growth: '摆脱过度依赖他人的倾向，培养果断的决策能力和个人主张。',
          guidance: '相信自己的直觉，勇敢地走出舒适圈，成为自己命运的主人。'
        },
        taurus: {
          purpose: '此生需要建立稳定、实用的价值观，学会享受简单的生活乐趣。',
          growth: '摆脱过度思虑和不安定的倾向，培养耐心和脚踏实地的品质。',
          guidance: '相信稳步前进的力量，在物质世界中找到真正的安全感。'
        },
        gemini: {
          purpose: '此生需要发展沟通能力和开放思维，学会从多角度看待事物。',
          growth: '摆脱固执己见和教条主义，培养好奇心和学习新知的热情。',
          guidance: '保持开放的心态，在交流中获得智慧，成为连接不同思想的桥梁。'
        },
        cancer: {
          purpose: '此生需要发展同情心和照顾能力，学会建立深度的情感连接。',
          growth: '摆脱过度控制和权威倾向，培养温柔关怀和情感敏感性。',
          guidance: '相信感情的力量，在关爱他人中找到自己的价值和意义。'
        },
        leo: {
          purpose: '此生需要发展创造力和自我表达，学会展现独特的个人魅力。',
          growth: '摆脱隐藏在群体中的倾向，培养自信和勇于表现的能力。',
          guidance: '相信自己的独特性，在创造和表达中找到生命的喜悦。'
        },
        virgo: {
          purpose: '此生需要发展实用技能和服务精神，学会关注细节和改进。',
          growth: '摆脱过度理想化的倾向，培养务实的工作态度和分析能力。',
          guidance: '在服务他人中找到意义，通过实际行动让世界变得更好。'
        },
        libra: {
          purpose: '此生需要发展合作能力和平衡智慧，学会建立和谐的关系。',
          growth: '摆脱过度自我中心的倾向，培养外交手腕和考虑他人的能力。',
          guidance: '在合作中找到力量，通过建立平衡创造美好的人际关系。'
        },
        scorpio: {
          purpose: '此生需要发展深度洞察力和转化能力，学会面对生命的深层真相。',
          growth: '摆脱停留在表面的倾向，培养勇气去探索隐藏的情感和动机。',
          guidance: '相信转化的力量，在深度体验中获得真正的智慧和力量。'
        },
        sagittarius: {
          purpose: '此生需要发展智慧和探索精神，学会追求更高的真理和意义。',
          growth: '摆脱过度关注细节的倾向，培养大局观和哲学思维。',
          guidance: '相信探索的价值，在追求智慧的旅程中找到人生的方向。'
        },
        capricorn: {
          purpose: '此生需要发展责任感和成就能力，学会建立可持续的成功。',
          growth: '摆脱过度依赖情感的倾向，培养理性规划和长远目标。',
          guidance: '相信努力的意义，在承担责任中建立真正的权威和成就。'
        },
        aquarius: {
          purpose: '此生需要发展独特性和人道精神，学会为集体利益而努力。',
          growth: '摆脱过度追求个人认可的倾向，培养客观视角和革新思维。',
          guidance: '相信进步的力量，在服务人类整体中找到个人的独特价值。'
        },
        pisces: {
          purpose: '此生需要发展同情心和精神敏感性，学会无条件的爱与宽恕。',
          growth: '摆脱过度批判和完美主义，培养包容和精神层面的理解。',
          guidance: '相信爱的治愈力量，在奉献和牺牲中找到精神的升华。'
        }
      },
      midheaven: {
        aries: {
